...
protected int station;
	...
	public void robotInit() {
		...
		m_chooser.addObject("Scale Right Side Field", new Scale());
		m_chooser.addObject("Scale Left Side Field", new ScaleLeft());
		m_chooser.addObject("Right Field Outside Side Switch", new SwitchSide());
		m_chooser.addObject("Left Field Outside Side Switch", new SwitchSideLeft());
		m_chooser.addObject("Left Field Switch-Scale", new LeftSideSwitchScale());
